...
@section('content')
    <div class="contentMain">
        <h2 class="pageNameContent">Fasilitas List</h2>
        <ol class="breadcrumb">
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="buttonAction">
                                    ...
                                    <a href="{{ route('admin.fasilitas.delete', ['id' => $item->id]) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="staticBackdropLabel">Add Fasilitas List</h5>
                ...
                <form action="{{ route('admin.fasilitas.store') }}" method="post">
                    ...
                    <div class="modal-body">
                        <div class="form-group mb-3">
                            <label class="form-label" for="name">Name Fasilitas</label>
                            <input type="text" class="form-control" name="name" id="name">
                        </div>
                        <div class="form-group mb-3">
                            <label class="form-label" for="desc">Deskripsi Fasilitas</label>
...
@section('js')
    ...
    <script>
        $('#updateTanaman').on('shown.bs.modal', function(e) {
            ...
            var html = `
    <div class="modal-header">
                <h5 class="modal-title" id="staticBackdropLabel">Edit Fasilitas List</h5>
                <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
            </div>
            <form action="/admin/fasilitas/${$(e.relatedTarget).data('id')}/update" method="post">
                @csrf
                <div class="modal-body">

                    <div class="form-group mb-3">
                        <label class="form-label" for="name">Nama Fasilitas</label>
                        <input type="text" class="form-control" name="name" value="${$(e.relatedTarget).data('name')}" id="name">
                    </div>
                    <div class="form-group mb-3">
                        <label class="form-label" for="desc">Deskripsi Fasilitas</label>
                        <input type="text" class="form-control" name="desc" value="${$(e.relatedTarget).data('desc')}" id="desc">
                    </div>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
